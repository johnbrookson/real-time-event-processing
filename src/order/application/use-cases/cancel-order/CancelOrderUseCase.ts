...
export class CancelOrderUseCase {
  ...
  async execute(dto: CancelOrderDTO): Promise<OrderResponseDTO> {
    try {
      this.logger.info('Cancelling order', { orderId: dto.orderId });
      ...
      this.logger.info('Order cancelled successfully', { orderId: order.id });
      ...
      this.logger.error('Error cancelling order', { error, dto });
      throw error;
    }
  }
} 