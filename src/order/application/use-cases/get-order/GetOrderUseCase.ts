...
export class GetOrderUseCase {
  ...
  async execute(dto: GetOrderDTO): Promise<OrderResponseDTO | null> {
    try {
      this.logger.info('Getting order', { orderId: dto.orderId });
      ...
      this.logger.info('Order found', { orderId: order.id });
      ...
      this.logger.error('Error getting order', { error, dto });
      throw error;
    }
  }
} 